...
class Solution {
    public int lengthOfLongestSubstring(String s) {
        ...
        // max length variable set to 0
        // loop using right pointer
        // 
        // check if difference between right pointer and left pointer is greater than max length
        // if so replace current max length to the new one
        int maxLength = 0;
        int left = 0;
